...
\begin{frame}[fragile]\frametitle{Literatura}
	\begin{itemize}
		\item Zasnovano na:\\
		Ciric Miroslav Matematička logika.\\
		(\url{http://www1.pmf.ni.ac.rs/pmf/predmeti/1001/ML-P09-K-1.pdf})\\

  
		Danas Beskonačno: Kako je nastao najinteligentniji simbol.\\
		(\url{https://www.danas.rs/zivot/beskonacno-kako-je-nastao-najinteligentniji-simbol/
Dnevni list Danas})\\

         Klarić Matea  Osnovna znanja o realnim brojevima u
nastavi matematike\\
		(\url{https://repozitorij.unios.hr/islandora/object/mathos%3A63/datastream/PDF/view})\\

		Weyl Hermann \textit{Levels of infinity: selected writings on mathematics and philosophy}\\

        Williamson James \textit{The Elements of Euclid. With Dissertations... by James Williamson}\\
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Ako $q$ nije prost, onda neki prost broj $p$ deli $q$. Kad bi ovaj broj $p$ bio u skupu, tada bi on delio $P$ ali $p$ deli $q$. Ako $p$ deli $P$ i $q$, onda bi $p$ morao da deli razliku ova dva broja. Posto ni jedan prost broj ne deli 1 $p$ ne može pripadati skupu.
    \end{itemize}
\end{itemize}
\end{frame}
