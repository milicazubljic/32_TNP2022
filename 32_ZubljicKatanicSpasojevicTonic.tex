...
Dakle, govorimo o \textbf{prebrojivoj beskonačnosti}. Ona se u matematici obeležava sa $\aleph_{0}$ ($\aleph$ - prvo slovo hebrejske azbuke). Ovu oznaku prvi je uveo nemački naučnik Georg Kantor u 19. veku\\
...
Neka je dat bilo koji konačni skup prirodnih brojeva $p_{1}, p_{2}, ..., p_{n}$. Biće pokazano da postoji barem još jedan prost broj koji se ne nalazi u listi. Neka je $P$ proizvod svih prostih brojeva u skupu: $P = p_{1}p_{2}...p_{n}$. Neka je $q = P + 1$. Tada $q$ ili jeste ili nije prost broj:
\begin{itemize}
...
Pretpostavkom da je skup x $\in$ (0,1) prebrojiv, zaključujemo da se taj skup može zapisati u obliku niza {x1,x2,x3}.
\newline
