...
Skupovi koji su prebrojivo beskonačni imaju kardinalni broj  {\displaystyle \aleph _{o}.\} (alef nula).
To su, na primer, skupovi prirodnih, celih i racionalnih brojeva.
Skup realnih brojeva nije prebrojiv, i njegov kardinalni broj naziva se kontinuum i označava se sa c>{\displaystyle \aleph _{0}.\,}.
